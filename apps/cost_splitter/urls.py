...
from . import api
from .views import AddCostFormView, AddCostSplitFormView, CostsListView, CostSplitReportListView, CostSplitReportView
...
urlpatterns = [
    ...
    path("add_report/", AddCostSplitFormView.as_view(), name="add_report"),
